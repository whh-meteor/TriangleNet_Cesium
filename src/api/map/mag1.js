...
const gradientColors = [
  Cesium.Color.fromCssColorString('#E24545'), // 红色 (最高强度)
  Cesium.Color.fromCssColorString('#F15A08'), // 深橙色
  Cesium.Color.fromCssColorString('#FE8A08'), // 浅橙色
  Cesium.Color.fromCssColorString('#F1D100'), // 黄色
  Cesium.Color.fromCssColorString('#D0E36D'), // 黄绿色
  Cesium.Color.fromCssColorString('#A4D04E'), // 亮绿色
  Cesium.Color.fromCssColorString('#7DB834'), // 绿色
  Cesium.Color.fromCssColorString('#4CB050'), // 深绿色
  Cesium.Color.fromCssColorString('#4BC0B3'), // 蓝绿色
  Cesium.Color.fromCssColorString('#0099CC'), // 蓝色
  Cesium.Color.fromCssColorString('#0055A5'), // 深海蓝
  Cesium.Color.fromCssColorString('#4A529A'), // 蓝紫色
  Cesium.Color.fromCssColorString('#6A4A93'), // 紫色
  Cesium.Color.fromCssColorString('#7A3A99'), // 深紫色
  Cesium.Color.fromCssColorString('#8B4DA3'), // 暗紫色
  Cesium.Color.fromCssColorString('#9E5AA5'), // 浅紫色
  Cesium.Color.fromCssColorString('#A15AAB'), // 粉紫色
  Cesium.Color.fromCssColorString('#B15BB8'), // 淡紫粉色
].reverse()
...
//   Cesium.Color.fromCssColorString('#6868FF')
// ].reverse();
...
function getGradientColor(value, minValue, maxValue) {
  ...
  const colorCount = gradientColors.length - 1; // 色带的区间数量
  const step = (maxValue - minValue) / colorCount; // 每个区间的宽度
  const index = Math.floor((value - minValue) / step); // 找到对应的区间索引
  const fraction = ((value - minValue) % step) / step; // 计算在当前区间内的比例
