...
export class CesiumPopup {
  constructor(viewer, options, action) {
    ...
    this.addPopup()
    if (
      !((_a = this.action) === null || _a === void 0 ? void 0 : _a.noLisener)
    ) {
      this.addMapListener()
      this.eventHandler = new ScreenSpaceEventHandler(viewer.scene.canvas)
      if (
        !((_b = this.action) === null || _b === void 0
          ? void 0
          : _b.contextDisabled)
      ) {
        this.createMenu()
      ...
      let self = this
      ;(_c = this.element) === null || _c === void 0
        ? void 0
        : _c.addEventListener(
            'click',
            function (e) {
    ...
    if (
      (_d = this.action) === null || _d === void 0 ? void 0 : _d.pickPosition
    ) {
  ...
  addMouseRightDownLisener() {
    var _a
    ;(_a = this.eventHandler) === null || _a === void 0
      ? void 0
      : _a.setInputAction((movement) => {
          var _a, _b, _c, _d
          if (this.actionState === 'edit') {
            if (
              ((_a = this.element) === null || _a === void 0
                ? void 0
                : _a.id) !==
              ((_b = this.selectValue) === null || _b === void 0
                ? void 0
                : _b.id)
            ) {
              return
          ...
          if (this.moved) {
            const cartesian3 =
              this.positionUtil.cartesian2ToCartesian3(position)
            this.positionUtil.changeMouseStyle(true)
            if (cartesian3) {
              this.setPosition(cartesian3)
              if (
                (_c = this.action) === null || _c === void 0
                  ? void 0
                  : _c.onChange
              ) {
                this.action.onChange(this)
              }
              ;(_d = this.tooltip) === null || _d === void 0
                ? void 0
                : _d.remove()
  ...
  addMouseLeftDownListener() {
    ...
    ;(_a = this.eventHandler) === null || _a === void 0
      ...
      : _a.setInputAction((movement) => {
          var _a
          ;(_a = this.contextmenu) === null || _a === void 0
            ? void 0
            : _a.remove()
  ...
  addMouseMoveLisener() {
    ...
    ;(_a = this.eventHandler) === null || _a === void 0
      ...
      : _a.setInputAction((movement) => {
          ...
          const cartesians3 =
            this.positionUtil.cartesian2ToCartesian3(endPosition)
          if (this.actionState === 'edit') {
            if (
              ((_a = this.element) === null || _a === void 0
                ? void 0
              ...
              if (this.moved && cartesians3) {
                ...
                this.moving = true
                ;(_c = this.contextmenu) === null || _c === void 0
                  ? void 0
                  : _c.remove()
  ...
  removeMouseLisener() {
    ...
    ;(_a = this.eventHandler) === null || _a === void 0
      ? void 0
      : _a.removeInputAction(ScreenSpaceEventType.MOUSE_MOVE)
    ;(_b = this.eventHandler) === null || _b === void 0
      ? void 0
      : _b.removeInputAction(ScreenSpaceEventType.RIGHT_DOWN)
    this.removeMouseLeftDownLisener()
  }
  removeMouseLeftDownLisener() {
    ...
    ;(_a = this.eventHandler) === null || _a === void 0
      ? void 0
      : _a.removeInputAction(ScreenSpaceEventType.LEFT_DOWN)
  }
  createMenu() {
    if (this.element && !this.moving)
      this.contextmenu = new CesiumPopupContextmenuUtil({
        ...
        onEdit: () => {
          var _a
          if (
            (_a = this.action) === null || _a === void 0 ? void 0 : _a.editAttr
          ) {
  ...
  setContent(html, init) {
    ...
    if (
      !init &&
      ((_a = this.action) === null || _a === void 0 ? void 0 : _a.onChange)
    ) {
      this.action.onChange(this)
    }
  }
  ...
  addCameraLisener() {
    ...
    if (
      (_a = this.options) === null || _a === void 0
        ? void 0
        : _a.visibleMaxCameraHeight
    ) {
      this.cameraMoveEnd =
        (_b = this.viewer) === null || _b === void 0
          ? void 0
          : _b.camera.moveEnd.addEventListener(() => {
              var _a, _b
              const h =
                (_a = this.viewer) === null || _a === void 0
                  ? void 0
                  : _a.camera.getMagnitude()
              const min = 6375000
              if (
                h &&
                ((_b = this.options) === null || _b === void 0
                  ? void 0
                  : _b.visibleMaxCameraHeight) &&
                this.element
              ) {
  ...
  addMapListener() {
    ...
    ;(_a = this.viewer) === null || _a === void 0
      ? void 0
      : _a.scene.postRender.addEventListener(() => {
          var _a, _b
          const position =
            (_a = this.options) === null || _a === void 0 ? void 0 : _a.position
          if (position) {
            if (
              (_b = this.options) === null || _b === void 0
                ? void 0
                : _b.renderInViewBounds
            ) {
